...
typedef struct {
    ...
    // 'device_rdma': rdma over device; 'device_urma': urma over device; 'device_sdma': sdma over device
    ...
    // (host_rdma, host_tcp or host_shm) or 1GB (device_sdma, device_rdma or device_urma)
