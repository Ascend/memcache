...
echo "cmake -G "$GENERATOR" -DCMAKE_BUILD_TYPE=DEBUG -DBUILD_GIT_COMMIT=OFF -DBUILD_GIT_COMMIT_GEN_FILE=OFF -DBUILD_TESTS=ON -DBUILD_OPEN_ABI=ON -DBUILD_COMPILER=gcc -S . -B ${BUILD_PATH}"
cmake -G "$GENERATOR" \
